...
<html>
    ...
    <header class="header">
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ms-auto mb-2 mb-lg-0 text-white">
                        ...
                        <li class="nav-item ">
                            <a class="nav-link p-5" href="Servicios.jsp">Servicios</a>
                        </li>
                        <li class="nav-item ">
                        ...
                        <div class="col-12 bg-white p-5 rounded-end">
                            ...
                            <form method="post" action="/Veterinaria_Huellitas/LoginController" class="">
                                ...
                                <div class="my-3">              
                                    ...
                                    <br>
                                    <span>
                                        <a href="#" data-bs-toggle="offcanvas" data-bs-target="#offcanvasRight" aria-controls="offcanvasRight">Recuperar Contraseña </a>
        ...
        <div class=" mb-sm-5 pt-5 ">
            <div class="offcanvas offcanvas-end rounded-3  canvas_tamaño " tabindex="-1" id="offcanvasRight"
                    ...
                    <div class="container align-content-lg-center ">
                        <div class=" col-12 bg-white p-5 rounded-end ">
                            <div class=" text-center">
                                ...
                                <p class="h2 fs-5"> <img class="ms-4" src="img/llave.png" alt="" width="50px" height="50px">CAMBIO DE CONTRASEÑA <br></p>
                                <span>Se recomienda usar una contraseña segura que no uses para ningun otro sitio </span>
                            </div>
                            <br>
                            <form method="post" action="/Veterinaria_Huellitas/LoginController" class="">
                                <div class="mb-4">
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="password" class="form-control" name="txtnuevacontraseña">
                                </div>
                                <div class="mb-4">
        ...
        <div class="container-fluid pt-5 ">
            <div class="offcanvas offcanvas-top rounded-3  canvas_tamaño" tabindex="-1" id="offcanvasTop"
                ...
                <form method="post" action="/Veterinaria_Huellitas/ClienteController" class="">
                    ...
                    <div class="container"> 
                        <button type="submit" class="btn btn-success  h-100 w-100 " name="btn_registrar">
    ...
    <div class="container-fluid bg-info p5"style="box-shadow: 5px 5px 15px">
        <div class="row text-center h-100 w-100 h5">
            <div class="text-white fs-2 h4 mt-3 text-center"><br>MAS DE 10 AÑOS TRABAJANDO PARA TU MASCOTA 
        ...
        <div class="row row-cols-1 row-cols-md-3 g-4">
            <div class="col">
                <div class="card" style="box-shadow: 5px 5px 15px;">
                    ...
                    <div class="card-body">
                        <h5 class="card-title">Jhonatan Castillo</h5>
            ...
            <div class="col">
                <div class="card "style="box-shadow: 5px 5px 15px">
                    <img src="img/card6.jpg" class="card-img-top" alt="..." height="595px">
                    <div class="card-body">
                        <h5 class="card-title">Candy Crash</h5>
                        <p class="card-text">This is a longer card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</p>
            ...
            <div class="col">
                <div class="card"style="box-shadow: 5px 5px 15px;">
                    ...
                    <div class="card-body">
                        <h5 class="card-title">Sofia Espinoza</h5>
