    ...
    <div class="row row-cols-1 row-cols-md-2 g-4 mt-3">
        ...
        <div class="col ">
            <div class="">
                ...
                <div class="card-body ">
                    <h5 class="card-title text-center h2 bg-warning mt-2 "><b>DRA. MILY TICCLLA ESPINOZA</b></h5>
                    <p class=""> <br><br> Médico Veterinario egresado de la Universidad Nacional Mayor de San Marcos,
        ...
        <div class="col">
            <div class="">
                ...
                <div class="card-body mt-5">
                    ...
                    <p class="card-text">
                      <br>  Médico Veterinario y Socia Co-Fundadora, egresada de la Universidad Nacional Mayor de San Marcos y Master en Administración de Negocios (MBA). Se desempeñó como Gerente de Línea en reconocidas empresas del medio veterinario por 12 años, adquiriendo amplia experiencia en el sector de animales de compañía y avicultura. </p>
        ...
        <div class="col ">
            <div class="">
                ...
                <div class="card-body ">
                    <h5 class="card-title text-center h2 bg-warning mt-3"><b>Dr. Jacinto</b></h5>
                    <p class=""> <br><br>Médico Veterinario egresado de la Universidad Nacional Mayor de San Marcos,
